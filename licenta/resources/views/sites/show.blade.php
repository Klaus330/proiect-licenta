        ...
        <div>
            @if ($stats)
                <div class="mt-3 flex flex-col">
                    @if ($site->isPending())
                        <span class="border-l-2 w-full p-2 rounded bg-blue-200  border-blue-400">
                            Your site uptime monitor is in queue. You'll get all the needed information in a minute.
                        </span>
                    @else
                        <span
                    ...
                    <span class="text-gray-500 mt-3">
                        Learn more about how to perform uptime checks <a href="/docs" class="underline">in our doc</a>.
                    </span>
            ...
            @else
                <div class="flex flex-col items-center justify-center h-full mt-5">
                    <svg class="w-20 h-20" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd"
                        clip-rule="evenodd">
                        <path
                            d="M15.853 16.56c-1.683 1.517-3.911 2.44-6.353 2.44-5.243 0-9.5-4.257-9.5-9.5s4.257-9.5 9.5-9.5 9.5 4.257 9.5 9.5c0 2.442-.923 4.67-2.44 6.353l7.44 7.44-.707.707-7.44-7.44zm-6.353-15.56c4.691 0 8.5 3.809 8.5 8.5s-3.809 8.5-8.5 8.5-8.5-3.809-8.5-8.5 3.809-8.5 8.5-8.5z" />
                    </svg>
                    <h2 class="mt-5 mb-2 font-bold text-2xl text-center">
