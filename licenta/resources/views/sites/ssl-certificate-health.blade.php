                            ...
                            <table class="w-full">
                                ...
                                <tbody class="w-full">
                                    ...
                                    <tr class="border-b  border-dashed border-gray-200 ">
                                      ...
                                      <td class="py-4 whitespace-nowrap text-sm text-gray-500 w-1/12 px-3 flex flex-col justify-start">
                                         <span>{{$site->sslCertificate->subject['CN']}}</span>
                                         <span>www.{{$site->sslCertificate->subject['CN']}}</span>
                                      </td>
                                      <td class="w-8/12"></td>
                                  </tr>
                                    <tr class="border-b  border-dashed border-gray-200 ">
